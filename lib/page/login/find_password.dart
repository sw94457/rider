...
import 'package:rider_app/page/login/password_change_page.dart';
                  ...
                  onPressed: () async {
                    ...
                    widget.bloc.findcheckIdAuth(phone: phone.text,id: id.text).then((res) {
                      if (res.success) {
                        ...
                        var data = res.data;
                        Navigator.push(context, MaterialPageRoute(builder: (context) => PasswordChangePage(widget.bloc,data: data,)));
                      } else {
                        Toast.show(res.errorMsg, context);
                      }
                    });
