...
class AddLicensePage extends StatefulWidget {
  ...
  AddLicensePage(this.bloc);

  @override
  _AddLicensePageState createState() => _AddLicensePageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('면허증 등록', style: TextStyle(color: AppColor.yellow)),
        centerTitle: true,
        backgroundColor: AppColor.navy,
      ),
      body: Container(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                            ...
                            children: [
                              Container(width: 344,height: 56,
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: [
                                    Image.asset('images/VectorStroke.png',width: 18,),
                  ...
                  //               ? FileImage(_image2)
                  //               : AssetImage('images/Group 77.png')),
                  //     ),
                  //     InkWell(
                  //       radius: 50,
                  //       child: Container(
